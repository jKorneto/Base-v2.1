...
Config.Weapons = {
	...
	{name = 'WEAPON_FRAGILE', label = "Hatchet Fragile", components = {}},
	{name = 'WEAPON_PENIS', label = "Objet étrange", components = {}},
	{name = 'WEAPON_WOLFKNIFE', label = "Wolf Knife", components = {}},
	{name = 'WEAPON_SPECIALHAMMER', label = "Special Hammer", components = {}},
	{name = 'WEAPON_MAZE', label = "Maze", components = {}},
    -- New
    {name = 'WEAPON_SCAR17', label = "Scar 17", components = {}},
    {name = 'WEAPON_TEC9M', label = "Tec 9 M", components = {}},
...
Config.WeaponsType = {
	melee = {
		...
		weapon_fragile = GetHashKey("WEAPON_FRAGILE"),
		weapon_penis = GetHashKey("WEAPON_PENIS"),
		weapon_wolfknife = GetHashKey("WEAPON_WOLFKNIFE"),
		weapon_specialhammer = GetHashKey("WEAPON_SPECIALHAMMER"),
		weapon_maze = GetHashKey("WEAPON_MAZE"),
        -- New
        weapon_scar17 = GetHashKey("WEAPON_SCAR17"),
        weapon_tec9m = GetHashKey("WEAPON_TEC9M"),
	},
	handguns = {
