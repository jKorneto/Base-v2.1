...
-- RegisterNetEvent('izeyy:pass:gift', function(level)
--     local source = source
...
--                             MySQL.Async.execute('UPDATE users SET coins = coins + @gift WHERE identifier = @identifier', {
--                                 ['@gift'] = closestReward.gift,
...
-- 						TriggerClientEvent("esx:showAdvancedNotification", xPlayer.source, "Notification", "ViceCity", "Vous avez récupérer votre récompense !","CHAR_KIRINSPECTEUR", 7)
-- 					end
-- 				end
-- 			end
-- 		else
