...
cfg_banSQL.TextFr = {
	...
	banplayer        = "/ban (ID) (Durée en heure) (Raison)",
	banplayeroff     = "/banoff (License) (Durée en heure) (Raison)",
	...
	yourban       = "\n\n🫀 Vous avez été banni de OneLife de façon temporaire 🫀",
	yourpermban   = "\n\n🫀 Vous avez été banni de OneLife de façon permanent 🫀",
