...
ESX.AddGroupCommand('ban', 'moderateur', function (source, args, user)
    ...
    local playerLicense = xTarget.identifier -- License du joueur
    local banDuration = args[2]    -- Durée du ban
    local reason = args[3]         -- Raison du ban
    exports["core"]:insertPlayerSanction(playerLicense, "ban", "Ban", nil, banDuration, reason, sanctionDate)
    banplayer(source, args)
			...
			elseif (tonumber(BanList[i].expiration)) > os.time() then
				...
				if tempsrestant >= 1440 then
					...
					local txtminutes = math.ceil(minutes)
						setKickReason(Text.yourban.."\n\n📌 ID de Ban : "..BanList[i].ban_id.."\n📃 Staff  : "..sourceplayername.."\n⏳ Temps de Ban : "..txtday..Text.day..txthrs..Text.hour..txtminutes..Text.minute.."\n📜 Raison du Ban : "..BanList[i].reason.."\n\n")
						CancelEvent()
						break
