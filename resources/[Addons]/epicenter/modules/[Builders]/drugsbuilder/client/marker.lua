        ...
        while true do
            ...
            for drugID, drugInfos in pairs(drugs) do
                ...
                if distance <= 5.0 then
                    ...
                    if distance <= 5.0 then
                        help("Appuyez sur ~INPUT_CONTEXT~ pour récolter ~s~"..drugInfos.name)
                ...
                if distance <= 5.0 then
                    ...
                    if distance <= 5.0 then
                        help("Appuyez sur ~INPUT_CONTEXT~ pour traiter ~s~"..drugInfos.name)
                        if IsControlJustPressed(0, 51) then
                            if not cooldown then
                                onInteract()
                                StartTransformAnim()
                ...
                if distance <= 5.0 and drugInfos.sale ~= 1 then
                    ...
                    if distance <= 5.0 then
                        help("Appuyez sur ~INPUT_CONTEXT~ pour vendre ~s~"..drugInfos.name)
                        if IsControlJustPressed(0, 51) then
                            if not cooldown then
                                onInteract()
                                StartSellAnim()
