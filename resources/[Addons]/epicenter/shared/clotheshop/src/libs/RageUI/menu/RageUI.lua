...
RageUIClothes.Settings = {
    ...
    Items = {
        ...
        Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 0, Width = 490.5 },
        Navigation = {
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu and (CurrentMenu.Display.Subtitle) then
            ...
            if CurrentMenu.Subtitle ~= "" then
                RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIClothes.ItemOffset, RageUIClothes.Settings.Items.Subtitle.Background.Width - 1 + CurrentMenu.WidthOffset, RageUIClothes.Settings.Items.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, 12, 16, 21, 255)
                ...
                RageUIClothes.ItemOffset = RageUIClothes.ItemOffset + RageUIClothes.Settings.Items.Subtitle.Background.Height + 10
            end
        end
    end
end
...
function RageUIClothes.Background()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Background) then
            ...
            -- RenderSprite(RageUIClothes.Settings.Items.Background.Dictionary, RageUIClothes.Settings.Items.Background.Texture, CurrentMenu.X, CurrentMenu.Y + RageUIClothes.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight, RageUIClothes.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUIClothes.ItemOffset, 0, 12, 16, 21, 255)

            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIClothes.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight, RageUIClothes.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUIClothes.ItemOffset + 7, 12, 16, 21, 255)
...
function RageUIClothes.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu then
            RageUIClothes.ItemsSafeZone(CurrentMenu)
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + Description.Background.Y + 10 + CurrentMenu.SubtitleHeight + RageUIClothes.ItemOffset, Description.Background.Width - 1 + CurrentMenu.WidthOffset, CurrentMenu.DescriptionHeight, 12, 16, 21, 255)
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.DescriptionHeight + 10 + CurrentMenu.SubtitleHeight + RageUIClothes.ItemOffset, Description.Bar.Width + CurrentMenu.WidthOffset, Description.Bar.Height, CurrentMenu.ButtonColor.R, CurrentMenu.ButtonColor.G, CurrentMenu.ButtonColor.B, CurrentMenu.ButtonColor.A)
            RenderText(CurrentMenu.Description, CurrentMenu.X + Description.Text.X, CurrentMenu.Y + Description.Text.Y + 10  + CurrentMenu.SubtitleHeight + RageUIClothes.ItemOffset, 0, Description.Text.Scale, 255, 255, 255, 255, nil, false, false, Description.Background.Width + CurrentMenu.WidthOffset - 8.0)
...
function RageUIClothes.ItemsDescription(CurrentMenu, Description, Selected)
    ...
    if Description ~= "" or Description ~= nil then
        ...
        if Selected and CurrentMenu.Description ~= Description then
            ...
            ---@type number
            local DescriptionLineCount = GetLineCount(CurrentMenu.Description, CurrentMenu.X + SettingsDescription.Text.X, CurrentMenu.Y + SettingsDescription.Text.Y + CurrentMenu.SubtitleHeight + RageUIClothes.ItemOffset, 0, SettingsDescription.Text.Scale, 12, 16, 21, 1, nil, false, false, SettingsDescription.Background.Width + (CurrentMenu.WidthOffset - 5.0))
