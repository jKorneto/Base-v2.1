...
RageUI.Settings = {
    ...
    Panels = {
        Grid = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 491, Height = 275 },
        ...
        Percentage = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 491, Height = 76 },
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu and (CurrentMenu.Display.Subtitle) then
            ...
            if CurrentMenu.Subtitle ~= "" then
                RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUI.ItemOffset, RageUI.Settings.Items.Subtitle.Background.Width - 1 + CurrentMenu.WidthOffset, RageUI.Settings.Items.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, 12, 16, 21, 255)
...
function RageUI.Background()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu and (CurrentMenu.Display.Background) then
            ...
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUI.Settings.Items.Background.Y + 10 + CurrentMenu.SubtitleHeight, RageUI.Settings.Items.Background.Width - 1 + CurrentMenu.WidthOffset, RageUI.ItemOffset, 12, 16, 21, 255)
...
function RageUI.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu then
            RageUI.ItemsSafeZone(CurrentMenu)
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + Description.Background.Y + 10 + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Description.Background.Width - 1 + CurrentMenu.WidthOffset, CurrentMenu.DescriptionHeight, 12, 16, 21, 255)
...
function RageUI.SetCurrentIndex(Index)
    RageUI.CurrentMenu.Index = Index
end
