...
local SettingsButton = {
    ...
    LeftBadge = { X = 15, Y = 0, Width = 35, Height = 35 },
    RightBadge = { X = 445, Y = 3, Width = 35, Height = 35 },
    RightText = { X = 480, Y = 3, Scale = 0.25 },
        ...
        if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
            ...
            if Enabled then
                ...
                elseif Submenu and not Style.RightLabel and not Style.RightBadge then
                    ...
                    RenderText(label, CurrentMenu.X-10 + SettingsButton.RightText.X - 10 - RightBadgeOffset + CurrentMenu.WidthOffset, CurrentMenu.Y + SettingsButton.RightText.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, SettingsButton.RightText.Scale, 255, 255, 255, 255, 2)
