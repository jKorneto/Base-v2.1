...
--                 TriggerClientEvent('creator:openCreator', args.playerId, nil, true)
--             end
...
--             if (args[1]) then
--                 TriggerClientEvent('creator:openCreator', args[1], nil, true)
--             end
--         end, Config.AdminCommand.Group)
--     end

--     QBCore.Functions.CreateCallback('creator:getCurrentSkin', function(source, cb)
