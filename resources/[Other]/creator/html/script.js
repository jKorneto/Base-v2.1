...
$(document).on('click', '.accept-skin', function(e){
    $.post('https://creator/closeCharacter');
    $("body").css("display", "none")
})

$(document).on('click', '.cancel-skin', function(e) {
    $.post('https://creator/cancel');
    $("body").css("display", "none")
})

$(document).on('click', '.hands-up', function(e) {
    $.post('https://creator/hands_up');
})
...
function previousClotheSets() {
    ...
    $.post('https://creator/change', JSON.stringify({
        type: 'clotheset', 
...
function changeHeight() {
    ...
    $.post('https://creator/change_height', JSON.stringify({height: changedHeight}));
}

function changeRotate() {
    var changedRotate = document.getElementById('rotate-input').value
    $.post('https://creator/change_rotate', JSON.stringify({rotate: changedRotate}));
}

function changeDistance() {
    var changedDistance = document.getElementById('distance-input').value
    $.post('https://creator/change_distance', JSON.stringify({distance: changedDistance}));
}

function changeCamera(type) {
    $.post('https://creator/change_camera', JSON.stringify({type: type}));
}
